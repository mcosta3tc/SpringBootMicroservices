...
*/
    ...
    // CLASSE UTILISÉE COMME EXEMPLE SANS BASE DE DONNÉE
...
public class ProductDaoI implements ProductDao {
    ...
    static {
        products.add(new Product(1, new String("Pc"), 300, 120));
        products.add(new Product(2, new String("Aspi"), 500, 200));
        products.add(new Product(3, new String("Table de Ping Pong"), 1500, 400));
    }
